...
<body>
    <nav class="navbar navbar-light navbar-expand bg-light navigation-clean">
        <div class="container"><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"></button><a class="navbar-brand" href="#">HomeThrough</a>
            <div class="collapse navbar-collapse" id="navcol-1"><a class="btn btn-primary ml-auto" role="button" href="#">Search</a></div>
        </div>
    </nav>
    <header class="masthead text-white text-center" style="background:url('assets/img/bg-masthead.jpg')no-repeat center center;background-size:cover;">
        <div class="overlay"><h3>Welcome to HomeThrough</h3></div>
        <div class="container">
            <div class="row">
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="mx-auto features-icons-item mb-5 mb-lg-0 mb-lg-3">
                        ...
                        <h3>Get Tuition at your Convenience</h3>
                        <p class="lead mb-0">Flexible and convenient where education comes at your door.</p>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="mx-auto features-icons-item mb-5 mb-lg-0 mb-lg-3">
                        <div class="d-flex features-icons-icon"><i class="icon-layers m-auto text-primary" data-bs-hover-animate="pulse"></i></div>
                        <h3>Get Personalised Attention</h3>
                        <p class="lead mb-0">Distinctive one-to-one tuition.</p>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="mx-auto features-icons-item mb-5 mb-lg-0 mb-lg-3">
                        ...
                        <p class="lead mb-0">Comfortable learning environment at home for better learning and freedom.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 my-auto h-100 text-center text-lg-left">
                    ...
                    <p class="text-muted small mb-4 mb-lg-0">© HomeThrough 2019. All Rights Reserved.</p>
                </div>
